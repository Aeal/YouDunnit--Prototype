...
public class TutorialTrigger : MonoBehaviour
{
	...
	public string 	MenuPrefabName = "Editor",
	                NotificationPrefabName = "UI Tutorial",
	...
	bool FindAttachAssets()
	{
		...
		{
			Debug.LogWarning("Tutorial Trigger object not set - looking it up manually.");
    ...
    void Start()
    {
		...
		{
           //Debug.LogError("Tutorial trigger " + gameObject.name + " was not initialized.");
		...
		else
		{
			...
			if (Interactive)
			{
            	...
            	m_interactiveObject = this.transform.FindChild("TriggerObject").gameObject;
			}
		}
    ...
    void FormatString()
    {
       ...
       //Debug.Log("DONE FORMATING LOLOLOLOL NOTICE ME HERE HIHIHIHIHHLLSLSLSLSFJASOIFJSDF;LKSDJFOIEJFSD!");

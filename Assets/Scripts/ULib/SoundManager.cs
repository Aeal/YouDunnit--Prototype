...
public class SoundManager : MonoBehaviour
{
    ...
    {
       //Debug.Log("Initilizing sound manager");
        if(instance == null)
		{
			instance = this;
		}
    ...
    public void Start()
    {
        ...
        Init(true, true, NumMusicChannels, NumSoundChannels, SoundDirectory);
    ...
    */
    ...
    public void LoadSounds(string Library = "default", string Directory = "Effects")
    {
       //Debug.Log(SoundDirectory + "/" + Directory);
        Object[] sound = Resources.LoadAll(SoundDirectory + "/" + Directory);
		if(!soundLibrary.ContainsKey(Library))
		{
			//Debug.Log("Library: " + Library.ToLower() + "Not found adding new library");	
        	soundLibrary.Add(Library.ToLower(),new Dictionary<string, AudioClip>());
		}
        foreach (Object o in sound)
        {
			//Debug.Log("Loading Sound: " + o.name.ToLower() + "Into Library: " + Library);
